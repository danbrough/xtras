...
export OPENSSL_ROOT_DIR=/files/cache/xtras/lib/openssl_androidArm64_3.6.3
...
if [ ! -d libssh2_git ]; then
  git clone https://github.com/libssh2 libssh2_git
  cd libssh2_git
  git checkout $LIBSSH2_FULL_VERSION
else
  cd libssh2_git
fi
...
for ANDROID_TARGET_PLATFORM in arm64-v8a; do
